...
export class CategoryService {
  private baseURL = "http://localhost:9890/api/category/Category"
...
addCategory(category: Category): Observable<Object>{
  return this.httpclient.post(`http://localhost:9890/api/category/add/Category`, category)
}
...
updateCategory(id:number, category:Category): Observable<Object>{
    return this.httpclient.put(`http://localhost:9890/api/category/update/Category`, category);
  }
